...
const BURMESE_TOPICS: Record<number, string[]> = {
  ...
  3: ['နှစ်သက်မှုများ ပြောခြင်း', 'မိသားစုနှင့် သူငယ်ချင်းများအကြောင်း ပြောခြင်း', 'ပြီးခဲ့သည့် အပတ်ကုန် အကြောင်းပြောခြင်း', 'အနာဂတ်အစီအစဉ်များ ပြောခြင်း', 'ဇာတ်ကောင်ဆောင် စကားပြောလေ့ကျင့်ခြင်း'],
