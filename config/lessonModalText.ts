...
export function getLessonModalText(defaultLanguage: DefaultLanguage): LessonModalText {
  if (defaultLanguage === 'burmese') {
    return {
      ...
      unitCompleteModalCancelLabel: 'ဒီယူနစ်မှာ နေမယ်',
      unitCompleteModalConfirmLabel: 'နောက်ယူနစ်သို့ ဆက်မယ်',
  ...
  return {
    ...
    unitCompleteModalCancelLabel: 'Stay on this unit',
    unitCompleteModalConfirmLabel: 'Continue to next unit',
