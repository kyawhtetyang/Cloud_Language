        ...
        {mode === 'learn' && (
          <div className="flex items-center justify-center gap-3 md:gap-4">
            <button
              ...
              aria-label="Previous"
              title="Previous"
              className={`h-12 w-12 md:h-14 md:w-14 rounded-full border-2 border-gray-200 bg-white text-gray-700 font-black text-xl md:text-2xl transition-all ${
            ...
            <button
              ...
              className={`h-14 w-14 md:h-16 md:w-16 rounded-full border-2 border-[#dbe8cb] bg-white text-[#2f7d01] font-black text-2xl md:text-3xl transition-all ${
            ...
            <button
              ...
              className={`h-12 w-12 md:h-14 md:w-14 rounded-full bg-[#58cc02] text-white font-black text-xl md:text-2xl duo-button-shadow transition-all ${
