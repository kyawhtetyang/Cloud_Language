...
export const ProgressBar: React.FC<ProgressBarProps> = ({
  ...
  const percentage = Math.min(100, Math.max(0, (unitCurrent / Math.max(unitTotal, 1)) * 100));

  return (
    <div className="w-full px-4 md:px-6 py-2 md:py-4 max-w-3xl mx-auto space-y-2 md:space-y-3">
      <div className="w-full flex items-center gap-3 bg-white border-2 border-gray-100 rounded-2xl px-3 py-3 shadow-sm">
        ...
        <div className="text-xs font-extrabold text-[#6f6f6f] uppercase tracking-wider bg-[#f7f7f7] border border-gray-200 px-2 py-1 rounded-lg">
